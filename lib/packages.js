...
const packages = {
  ...
  mionfast: {
    checked: true,
    hasRouter: true,
    package: "@MionKit/mionfast",
    validation: "✓",
    version: "0.1.0",
    description: "Fastifi sertver instead @mionkit/http.",
  },
  mionnoserialisation: {
    checked: true,
    hasRouter: true,
    ...
    validation: "✓",
    version: "0.1.0",
    description: "mion with serialization nad validation disabled.",
  },
  deepkit: {
    hasRouter: true,
