...
}, fn: void 0 }, "is_nDtnjh": { isNoop: false, typeName: "string", fnID: "is", jitFnHash: "is_nDtnjh", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function is_nDtnjh(v){return typeof v === 'string'}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_nDtnjh(utl) {
  return function is_nDtnjh(v) {
    return typeof v === "string";
  };
}, fn: void 0 }, "te_nDtnjh": { isNoop: false, typeName: "string", fnID: "te", jitFnHash: "te_nDtnjh", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_nDtnjh(v,pth=[],er=[]){if (typeof v !== 'string') Iqa2M8Ms(pth,er,"string"); return er}`, jitDependencies: [], pureFnDependencies: ["mion::newRunTypeErr"], createJitFn: function get_te_nDtnjh(utl) {
  const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr");
  return function te_nDtnjh(v, pth = [], er = []) {
    if (typeof v !== "string") Iqa2M8Ms(pth, er, "string");
    return er;
  };
}, fn: void 0 }, "tj_nDtnjh": { isNoop: true, typeName: "string", fnID: "tj", jitFnHash: "tj_nDtnjh", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function tj_nDtnjh(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tj_nDtnjh(utl) {
  return function tj_nDtnjh(v) {
    return v;
  };
}, fn: void 0 }, "fj_nDtnjh": { isNoop: true, typeName: "string", fnID: "fj", jitFnHash: "fj_nDtnjh", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function fj_nDtnjh(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fj_nDtnjh(utl) {
  return function fj_nDtnjh(v) {
    return v;
  };
}, fn: void 0 }, "sj_nDtnjh": { isNoop: false, typeName: "string", fnID: "sj", jitFnHash: "sj_nDtnjh", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function sj_nDtnjh(v){return JSON.stringify(v)}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_sj_nDtnjh(utl) {
  return function sj_nDtnjh(v) {
    return JSON.stringify(v);
  };
}, fn: void 0 }, "tBi_nDtnjh": { isNoop: false, typeName: "string", fnID: "tBi", jitFnHash: "tBi_nDtnjh", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: "'use strict';  return function tBi_nDtnjh(v,Ser){Ser.serString(v); return Ser}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tBi_nDtnjh(utl) {
  return function tBi_nDtnjh(v, Ser) {
    Ser.serString(v);
    return Ser;
  };
}, fn: void 0 }, "fBi_nDtnjh": { isNoop: false, typeName: "string", fnID: "fBi", jitFnHash: "fBi_nDtnjh", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: "'use strict';  return function fBi_nDtnjh(ret,Des){return Des.desString()}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fBi_nDtnjh(utl) {
  return function fBi_nDtnjh(ret, Des) {
    return Des.desString();
  };
}, fn: void 0 }, "is_h19ZNf": { isNoop: false, typeName: "params", fnID: "is", jitFnHash: "is_h19ZNf", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_tFhdZH = utl.getJIT("is_tFhdZH"); return function is_h19ZNf(v){return (v.length <= 1 && is_tFhdZH.fn(v[0]))}`, jitDependencies: ["is_tFhdZH"], pureFnDependencies: [], createJitFn: function get_is_h19ZNf(utl) {
  const is_tFhdZH = utl.getJIT("is_tFhdZH");
  return function is_h19ZNf(v) {
    return v.length <= 1 && is_tFhdZH.fn(v[0]);
  };
}, fn: void 0 }, "is_tFhdZH": { isNoop: false, typeName: "User", fnID: "is", jitFnHash: "is_tFhdZH", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_bBXtdP = utl.getJIT("is_bBXtdP");
...
}, fn: void 0 }, "is_bBXtdP": { isNoop: false, typeName: "UserRole", fnID: "is", jitFnHash: "is_bBXtdP", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function is_bBXtdP(v){return (v === "admin" || v === "user" || v === "guest" || v === "moderator")}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_bBXtdP(utl) {
  return function is_bBXtdP(v) {
    return v === "admin" || v === "user" || v === "guest" || v === "moderator";
  };
}, fn: void 0 }, "is_CGMEgg": { isNoop: false, typeName: "AccountStatus", fnID: "is", jitFnHash: "is_CGMEgg", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function is_CGMEgg(v){return (v === "active" || v === "suspended" || v === "pending_verification" || v === "deactivated")}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_CGMEgg(utl) {
  return function is_CGMEgg(v) {
    return v === "active" || v === "suspended" || v === "pending_verification" || v === "deactivated";
  };
}, fn: void 0 }, "is_aic2mg": { isNoop: false, typeName: "Address", fnID: "is", jitFnHash: "is_aic2mg", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function is_aic2mg(v){return (typeof v === 'object' && v !== null && typeof v.street === 'string' && typeof v.city === 'string' && typeof v.state === 'string' && typeof v.zipCode === 'string' && typeof v.country === 'string')}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_aic2mg(utl) {
...
}, fn: void 0 }, "is_qU6qiY": { isNoop: false, typeName: "array", fnID: "is", jitFnHash: "is_qU6qiY", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_BTvJh1 = utl.getJIT("is_BTvJh1"); return function is_qU6qiY(v){
 if (!Array.isArray(v)) return false;
 for (let i0 = 0; i0 < v.length; i0++) {
...
}, fn: void 0 }, "is_gsmM62": { isNoop: false, typeName: "NotificationSettings", fnID: "is", jitFnHash: "is_gsmM62", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function is_gsmM62(v){return (typeof v === 'object' && v !== null && typeof v.email === 'boolean' && typeof v.sms === 'boolean' && typeof v.push === 'boolean' && (v.frequency === "immediate" || v.frequency === "daily" || v.frequency === "weekly"))}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_gsmM62(utl) {
...
}, fn: void 0 }, "te_h19ZNf": { isNoop: false, typeName: "params", fnID: "te", jitFnHash: "te_h19ZNf", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const te_tFhdZH = utl.getJIT("te_tFhdZH");
...
}, fn: void 0 }, "te_tFhdZH": { isNoop: false, typeName: "User", fnID: "te", jitFnHash: "te_tFhdZH", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr");
...
}, fn: void 0 }, "te_bBXtdP": { isNoop: false, typeName: "UserRole", fnID: "te", jitFnHash: "te_bBXtdP", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const is_bBXtdP = utl.getJIT("is_bBXtdP");
...
}, fn: void 0 }, "te_CGMEgg": { isNoop: false, typeName: "AccountStatus", fnID: "te", jitFnHash: "te_CGMEgg", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const is_CGMEgg = utl.getJIT("is_CGMEgg");
...
}, fn: void 0 }, "te_aic2mg": { isNoop: false, typeName: "Address", fnID: "te", jitFnHash: "te_aic2mg", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_aic2mg(v,pth=[],er=[]){
 if (!(typeof v === 'object' && v !== null)) {
 Iqa2M8Ms(pth,er,"object");
 } else {
...
}, fn: void 0 }, "te_qU6qiY": { isNoop: false, typeName: "array", fnID: "te", jitFnHash: "te_qU6qiY", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const te_BTvJh1 = utl.getJIT("te_BTvJh1");
...
}, fn: void 0 }, "te_BTvJh1": { isNoop: false, typeName: "PaymentMethod", fnID: "te", jitFnHash: "te_BTvJh1", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const is_BTvJh1 = utl.getJIT("is_BTvJh1");
...
}, fn: void 0 }, "te_Pp7DlV": { isNoop: false, typeName: "UserPreferences", fnID: "te", jitFnHash: "te_Pp7DlV", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr");
...
}, fn: void 0 }, "te_gsmM62": { isNoop: false, typeName: "NotificationSettings", fnID: "te", jitFnHash: "te_gsmM62", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_gsmM62(v,pth=[],er=[]){
 if (!(typeof v === 'object' && v !== null)) {
 Iqa2M8Ms(pth,er,"object");
 } else {
...
}, fn: void 0 }, "tj_h19ZNf": { isNoop: false, typeName: "params", fnID: "tj", jitFnHash: "tj_h19ZNf", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const tj_tFhdZH = utl.getJIT("tj_tFhdZH"); return function tj_h19ZNf(v){v[0] = tj_tFhdZH.fn(v[0]); return v}`, jitDependencies: ["tj_tFhdZH"], pureFnDependencies: [], createJitFn: function get_tj_h19ZNf(utl) {
  const tj_tFhdZH = utl.getJIT("tj_tFhdZH");
  return function tj_h19ZNf(v) {
    v[0] = tj_tFhdZH.fn(v[0]);
    return v;
  };
}, fn: void 0 }, "tj_tFhdZH": { isNoop: false, typeName: "User", fnID: "tj", jitFnHash: "tj_tFhdZH", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const tj_bBXtdP = utl.getJIT("tj_bBXtdP");
...
}, fn: void 0 }, "tj_aic2mg": { isNoop: true, typeName: "Address", fnID: "tj", jitFnHash: "tj_aic2mg", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function tj_aic2mg(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tj_aic2mg(utl) {
  return function tj_aic2mg(v) {
    return v;
  };
}, fn: void 0 }, "tj_qU6qiY": { isNoop: false, typeName: "array", fnID: "tj", jitFnHash: "tj_qU6qiY", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const tj_BTvJh1 = utl.getJIT("tj_BTvJh1"); return function tj_qU6qiY(v){for (let i0 = 0; i0 < v.length; i0++) {v[i0] = tj_BTvJh1.fn(v[i0]);} return v}`, jitDependencies: ["tj_BTvJh1"], pureFnDependencies: [], createJitFn: function get_tj_qU6qiY(utl) {
...
}, fn: void 0 }, "tj_Pp7DlV": { isNoop: false, typeName: "UserPreferences", fnID: "tj", jitFnHash: "tj_Pp7DlV", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json encode union: item does not belong to the union";
...
}, fn: void 0 }, "fj_h19ZNf": { isNoop: false, typeName: "params", fnID: "fj", jitFnHash: "fj_h19ZNf", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_tFhdZH = utl.getJIT("fj_tFhdZH"); return function fj_h19ZNf(v){v[0] = fj_tFhdZH.fn(v[0]); return v}`, jitDependencies: ["fj_tFhdZH"], pureFnDependencies: [], createJitFn: function get_fj_h19ZNf(utl) {
  const fj_tFhdZH = utl.getJIT("fj_tFhdZH");
  return function fj_h19ZNf(v) {
    v[0] = fj_tFhdZH.fn(v[0]);
    return v;
  };
}, fn: void 0 }, "fj_tFhdZH": { isNoop: false, typeName: "User", fnID: "fj", jitFnHash: "fj_tFhdZH", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_bBXtdP = utl.getJIT("fj_bBXtdP");
...
}, fn: void 0 }, "fj_bBXtdP": { isNoop: false, typeName: "UserRole", fnID: "fj", jitFnHash: "fj_bBXtdP", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_bBXtdP(v){
 if (v?.length === 2 && Array.isArray(v) && typeof v[0] === 'number') {
 const dec0 = v[0]; v = v[1];
...
}, fn: void 0 }, "fj_CGMEgg": { isNoop: false, typeName: "AccountStatus", fnID: "fj", jitFnHash: "fj_CGMEgg", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_CGMEgg(v){
 if (v?.length === 2 && Array.isArray(v) && typeof v[0] === 'number') {
 const dec0 = v[0]; v = v[1];
 if (dec0 === 0) {/*noop*/}else if (dec0 === 1) {/*noop*/}else if (dec0 === 2) {/*noop*/}else if (dec0 === 3) {/*noop*/}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fj_aic2mg": { isNoop: true, typeName: "Address", fnID: "fj", jitFnHash: "fj_aic2mg", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function fj_aic2mg(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fj_aic2mg(utl) {
  return function fj_aic2mg(v) {
    return v;
  };
}, fn: void 0 }, "fj_qU6qiY": { isNoop: false, typeName: "array", fnID: "fj", jitFnHash: "fj_qU6qiY", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_BTvJh1 = utl.getJIT("fj_BTvJh1"); return function fj_qU6qiY(v){for (let i0 = 0; i0 < v.length; i0++) {v[i0] = fj_BTvJh1.fn(v[i0]);} return v}`, jitDependencies: ["fj_BTvJh1"], pureFnDependencies: [], createJitFn: function get_fj_qU6qiY(utl) {
...
}, fn: void 0 }, "fj_BTvJh1": { isNoop: false, typeName: "PaymentMethod", fnID: "fj", jitFnHash: "fj_BTvJh1", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_BTvJh1(v){
 if (v?.length === 2 && Array.isArray(v) && typeof v[0] === 'number') {
 const dec0 = v[0]; v = v[1];
 if (dec0 === 0) {/*noop*/}else if (dec0 === 1) {/*noop*/}else if (dec0 === 2) {/*noop*/}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fj_Pp7DlV": { isNoop: false, typeName: "UserPreferences", fnID: "fj", jitFnHash: "fj_Pp7DlV", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index";
...
}, fn: void 0 }, "fj_gsmM62": { isNoop: false, typeName: "NotificationSettings", fnID: "fj", jitFnHash: "fj_gsmM62", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_gsmM62(v){
...
}, fn: void 0 }, "sj_h19ZNf": { isNoop: false, typeName: "params", fnID: "sj", jitFnHash: "sj_h19ZNf", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_tFhdZH = utl.getJIT("sj_tFhdZH"); return function sj_h19ZNf(v){return '['+sj_tFhdZH.fn(v[0])+']'}`, jitDependencies: ["sj_tFhdZH"], pureFnDependencies: [], createJitFn: function get_sj_h19ZNf(utl) {
  const sj_tFhdZH = utl.getJIT("sj_tFhdZH");
  return function sj_h19ZNf(v) {
    return "[" + sj_tFhdZH.fn(v[0]) + "]";
  };
}, fn: void 0 }, "sj_tFhdZH": { isNoop: false, typeName: "User", fnID: "sj", jitFnHash: "sj_tFhdZH", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_bBXtdP = utl.getJIT("sj_bBXtdP");
...
}, fn: void 0 }, "sj_qU6qiY": { isNoop: false, typeName: "array", fnID: "sj", jitFnHash: "sj_qU6qiY", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_BTvJh1 = utl.getJIT("sj_BTvJh1"); return function sj_qU6qiY(v){
 const ls0 = [];
 for (let i0 = 0; i0 < v.length; i0++) {
...
}, fn: void 0 }, "sj_Pp7DlV": { isNoop: false, typeName: "UserPreferences", fnID: "sj", jitFnHash: "sj_Pp7DlV", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not StringifyJson union: item does not belong to the union";
...
}, fn: void 0 }, "tBi_h19ZNf": { isNoop: false, typeName: "params", fnID: "tBi", jitFnHash: "tBi_h19ZNf", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_tFhdZH = utl.getJIT("tBi_tFhdZH"); return function tBi_h19ZNf(v,Ser){const tbmI0 = Ser.index; Ser.view.setUint8(Ser.index++, 0)
...
}, fn: void 0 }, "tBi_tFhdZH": { isNoop: false, typeName: "User", fnID: "tBi", jitFnHash: "tBi_tFhdZH", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_bBXtdP = utl.getJIT("tBi_bBXtdP");
...
}, fn: void 0 }, "tBi_aic2mg": { isNoop: false, typeName: "Address", fnID: "tBi", jitFnHash: "tBi_aic2mg", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: "'use strict';  return function tBi_aic2mg(v,Ser){Ser.serString(v.street);Ser.serString(v.city);Ser.serString(v.state);Ser.serString(v.zipCode);Ser.serString(v.country);\n; return Ser}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tBi_aic2mg(utl) {
...
}, fn: void 0 }, "tBi_qU6qiY": { isNoop: false, typeName: "array", fnID: "tBi", jitFnHash: "tBi_qU6qiY", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_BTvJh1 = utl.getJIT("tBi_BTvJh1"); return function tBi_qU6qiY(v,Ser){
 Ser.view.setUint32(Ser.index, v.length, 1); Ser.index += 4;
...
}, fn: void 0 }, "tBi_Pp7DlV": { isNoop: false, typeName: "UserPreferences", fnID: "tBi", jitFnHash: "tBi_Pp7DlV", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not encode union to binary: item does not belong to the union";
...
}, fn: void 0 }, "fBi_h19ZNf": { isNoop: false, typeName: "params", fnID: "fBi", jitFnHash: "fBi_h19ZNf", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_tFhdZH = utl.getJIT("fBi_tFhdZH"); return function fBi_h19ZNf(ret,Des){ret = [];const tbimI0 = Des.index; Des.index += 1;
...
}, fn: void 0 }, "fBi_tFhdZH": { isNoop: false, typeName: "User", fnID: "fBi", jitFnHash: "fBi_tFhdZH", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_bBXtdP = utl.getJIT("fBi_bBXtdP");
...
}, fn: void 0 }, "fBi_bBXtdP": { isNoop: false, typeName: "UserRole", fnID: "fBi", jitFnHash: "fBi_bBXtdP", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index"; return function fBi_bBXtdP(ret,Des){
 const dec0 = Des.view.getUint8(Des.index++);
...
}, fn: void 0 }, "fBi_CGMEgg": { isNoop: false, typeName: "AccountStatus", fnID: "fBi", jitFnHash: "fBi_CGMEgg", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index"; return function fBi_CGMEgg(ret,Des){
 const dec0 = Des.view.getUint8(Des.index++);
...
}, fn: void 0 }, "fBi_aic2mg": { isNoop: false, typeName: "Address", fnID: "fBi", jitFnHash: "fBi_aic2mg", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: "'use strict';  return function fBi_aic2mg(ret,Des){return {street:Des.desString(),city:Des.desString(),state:Des.desString(),zipCode:Des.desString(),country:Des.desString()}}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fBi_aic2mg(utl) {
...
}, fn: void 0 }, "fBi_qU6qiY": { isNoop: false, typeName: "array", fnID: "fBi", jitFnHash: "fBi_qU6qiY", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_BTvJh1 = utl.getJIT("fBi_BTvJh1"); return function fBi_qU6qiY(ret,Des){
 const arrL0 = Des.view.getUint32(Des.index, 1); Des.index += 4; ret = new Array(arrL0);
...
}, fn: void 0 }, "fBi_BTvJh1": { isNoop: false, typeName: "PaymentMethod", fnID: "fBi", jitFnHash: "fBi_BTvJh1", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index"; return function fBi_BTvJh1(ret,Des){
 const dec0 = Des.view.getUint8(Des.index++);
...
}, fn: void 0 }, "fBi_Pp7DlV": { isNoop: false, typeName: "UserPreferences", fnID: "fBi", jitFnHash: "fBi_Pp7DlV", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index";
...
}, fn: void 0 }, "is_KgA2s8": { isNoop: false, typeName: "User", fnID: "is", jitFnHash: "is_KgA2s8", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_E2YuG4 = utl.getJIT("is_E2YuG4");
...
}, fn: void 0 }, "is_E2YuG4": { isNoop: false, typeName: "UserRole", fnID: "is", jitFnHash: "is_E2YuG4", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function is_E2YuG4(v){return (v === "admin" || v === "user" || v === "guest" || v === "moderator")}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_E2YuG4(utl) {
  return function is_E2YuG4(v) {
    return v === "admin" || v === "user" || v === "guest" || v === "moderator";
  };
}, fn: void 0 }, "is_vtjtZH": { isNoop: false, typeName: "AccountStatus", fnID: "is", jitFnHash: "is_vtjtZH", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function is_vtjtZH(v){return (v === "active" || v === "suspended" || v === "pending_verification" || v === "deactivated")}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_vtjtZH(utl) {
  return function is_vtjtZH(v) {
    return v === "active" || v === "suspended" || v === "pending_verification" || v === "deactivated";
  };
}, fn: void 0 }, "is_DD9DVL": { isNoop: false, typeName: "Address", fnID: "is", jitFnHash: "is_DD9DVL", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function is_DD9DVL(v){return (typeof v === 'object' && v !== null && typeof v.street === 'string' && typeof v.city === 'string' && typeof v.state === 'string' && typeof v.zipCode === 'string' && typeof v.country === 'string')}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_DD9DVL(utl) {
  return function is_DD9DVL(v) {
    return typeof v === "object" && v !== null && typeof v.street === "string" && typeof v.city === "string" && typeof v.state === "string" && typeof v.zipCode === "string" && typeof v.country === "string";
  };
}, fn: void 0 }, "is_P9r7Jh": { isNoop: false, typeName: "array", fnID: "is", jitFnHash: "is_P9r7Jh", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const is_G2AKWU = utl.getJIT("is_G2AKWU"); return function is_P9r7Jh(v){
 if (!Array.isArray(v)) return false;
 for (let i0 = 0; i0 < v.length; i0++) {
...
}, fn: void 0 }, "is_tfLdnp": { isNoop: false, typeName: "NotificationSettings", fnID: "is", jitFnHash: "is_tfLdnp", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function is_tfLdnp(v){return (typeof v === 'object' && v !== null && typeof v.email === 'boolean' && typeof v.sms === 'boolean' && typeof v.push === 'boolean' && (v.frequency === "immediate" || v.frequency === "daily" || v.frequency === "weekly"))}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_tfLdnp(utl) {
  return function is_tfLdnp(v) {
    return typeof v === "object" && v !== null && typeof v.email === "boolean" && typeof v.sms === "boolean" && typeof v.push === "boolean" && (v.frequency === "immediate" || v.frequency === "daily" || v.frequency === "weekly");
  };
}, fn: void 0 }, "te_KgA2s8": { isNoop: false, typeName: "User", fnID: "te", jitFnHash: "te_KgA2s8", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr");
...
}, fn: void 0 }, "te_E2YuG4": { isNoop: false, typeName: "UserRole", fnID: "te", jitFnHash: "te_E2YuG4", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const is_E2YuG4 = utl.getJIT("is_E2YuG4");
...
}, fn: void 0 }, "te_vtjtZH": { isNoop: false, typeName: "AccountStatus", fnID: "te", jitFnHash: "te_vtjtZH", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const is_vtjtZH = utl.getJIT("is_vtjtZH");
...
}, fn: void 0 }, "te_DD9DVL": { isNoop: false, typeName: "Address", fnID: "te", jitFnHash: "te_DD9DVL", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_DD9DVL(v,pth=[],er=[]){
 if (!(typeof v === 'object' && v !== null)) {
 Iqa2M8Ms(pth,er,"object");
 } else {
 if (typeof v.street !== 'string') Iqa2M8Ms(pth,er,"string",["street"]);if (typeof v.city !== 'string') Iqa2M8Ms(pth,er,"string",["city"]);if (typeof v.state !== 'string') Iqa2M8Ms(pth,er,"string",["state"]);if (typeof v.zipCode !== 'string') Iqa2M8Ms(pth,er,"string",["zipCode"]);if (typeof v.country !== 'string') Iqa2M8Ms(pth,er,"string",["country"]);
...
}, fn: void 0 }, "te_P9r7Jh": { isNoop: false, typeName: "array", fnID: "te", jitFnHash: "te_P9r7Jh", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const te_G2AKWU = utl.getJIT("te_G2AKWU");
...
}, fn: void 0 }, "te_G2AKWU": { isNoop: false, typeName: "PaymentMethod", fnID: "te", jitFnHash: "te_G2AKWU", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const is_G2AKWU = utl.getJIT("is_G2AKWU");
...
}, fn: void 0 }, "te_AWciwE": { isNoop: false, typeName: "UserPreferences", fnID: "te", jitFnHash: "te_AWciwE", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr");
...
}, fn: void 0 }, "te_tfLdnp": { isNoop: false, typeName: "NotificationSettings", fnID: "te", jitFnHash: "te_tfLdnp", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_tfLdnp(v,pth=[],er=[]){
 if (!(typeof v === 'object' && v !== null)) {
 Iqa2M8Ms(pth,er,"object");
 } else {
 if (typeof v.email !== 'boolean') Iqa2M8Ms(pth,er,"boolean",["email"]);if (typeof v.sms !== 'boolean') Iqa2M8Ms(pth,er,"boolean",["sms"]);if (typeof v.push !== 'boolean') Iqa2M8Ms(pth,er,"boolean",["push"]);if (!(v.frequency === "immediate" || v.frequency === "daily" || v.frequency === "weekly")) Iqa2M8Ms(pth,er,"union",["frequency"]);
...
}, fn: void 0 }, "tj_KgA2s8": { isNoop: false, typeName: "User", fnID: "tj", jitFnHash: "tj_KgA2s8", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const tj_E2YuG4 = utl.getJIT("tj_E2YuG4");
...
}, fn: void 0 }, "tj_AWciwE": { isNoop: false, typeName: "UserPreferences", fnID: "tj", jitFnHash: "tj_AWciwE", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json encode union: item does not belong to the union";
...
}, fn: void 0 }, "fj_KgA2s8": { isNoop: false, typeName: "User", fnID: "fj", jitFnHash: "fj_KgA2s8", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_E2YuG4 = utl.getJIT("fj_E2YuG4");
...
}, fn: void 0 }, "fj_E2YuG4": { isNoop: false, typeName: "UserRole", fnID: "fj", jitFnHash: "fj_E2YuG4", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_E2YuG4(v){
 if (v?.length === 2 && Array.isArray(v) && typeof v[0] === 'number') {
 const dec0 = v[0]; v = v[1];
 if (dec0 === 0) {/*noop*/}else if (dec0 === 1) {/*noop*/}else if (dec0 === 2) {/*noop*/}else if (dec0 === 3) {/*noop*/}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fj_vtjtZH": { isNoop: false, typeName: "AccountStatus", fnID: "fj", jitFnHash: "fj_vtjtZH", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_vtjtZH(v){
 if (v?.length === 2 && Array.isArray(v) && typeof v[0] === 'number') {
 const dec0 = v[0]; v = v[1];
 if (dec0 === 0) {/*noop*/}else if (dec0 === 1) {/*noop*/}else if (dec0 === 2) {/*noop*/}else if (dec0 === 3) {/*noop*/}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fj_DD9DVL": { isNoop: true, typeName: "Address", fnID: "fj", jitFnHash: "fj_DD9DVL", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function fj_DD9DVL(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fj_DD9DVL(utl) {
  return function fj_DD9DVL(v) {
    return v;
  };
}, fn: void 0 }, "fj_P9r7Jh": { isNoop: false, typeName: "array", fnID: "fj", jitFnHash: "fj_P9r7Jh", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_G2AKWU = utl.getJIT("fj_G2AKWU"); return function fj_P9r7Jh(v){for (let i0 = 0; i0 < v.length; i0++) {v[i0] = fj_G2AKWU.fn(v[i0]);} return v}`, jitDependencies: ["fj_G2AKWU"], pureFnDependencies: [], createJitFn: function get_fj_P9r7Jh(utl) {
...
}, fn: void 0 }, "fj_G2AKWU": { isNoop: false, typeName: "PaymentMethod", fnID: "fj", jitFnHash: "fj_G2AKWU", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_G2AKWU(v){
 if (v?.length === 2 && Array.isArray(v) && typeof v[0] === 'number') {
 const dec0 = v[0]; v = v[1];
 if (dec0 === 0) {/*noop*/}else if (dec0 === 1) {/*noop*/}else if (dec0 === 2) {/*noop*/}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fj_AWciwE": { isNoop: false, typeName: "UserPreferences", fnID: "fj", jitFnHash: "fj_AWciwE", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index";
...
}, fn: void 0 }, "fj_tfLdnp": { isNoop: false, typeName: "NotificationSettings", fnID: "fj", jitFnHash: "fj_tfLdnp", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not json decode union: invalid union index"; return function fj_tfLdnp(v){
 if (v.frequency?.length === 2 && Array.isArray(v.frequency) && typeof v.frequency[0] === 'number') {
 const dec0 = v.frequency[0]; v.frequency = v.frequency[1];
 if (dec0 === 0) {/*noop*/}else if (dec0 === 1) {/*noop*/}else if (dec0 === 2) {/*noop*/}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "sj_KgA2s8": { isNoop: false, typeName: "User", fnID: "sj", jitFnHash: "sj_KgA2s8", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_E2YuG4 = utl.getJIT("sj_E2YuG4");
...
}, fn: void 0 }, "sj_DD9DVL": { isNoop: false, typeName: "Address", fnID: "sj", jitFnHash: "sj_DD9DVL", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function sj_DD9DVL(v){return '{'+'"street":'+JSON.stringify(v.street)+","+'"city":'+JSON.stringify(v.city)+","+'"state":'+JSON.stringify(v.state)+","+'"zipCode":'+JSON.stringify(v.zipCode)+","+'"country":'+JSON.stringify(v.country)+'}'}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_sj_DD9DVL(utl) {
  return function sj_DD9DVL(v) {
    return '{"street":' + JSON.stringify(v.street) + ',"city":' + JSON.stringify(v.city) + ',"state":' + JSON.stringify(v.state) + ',"zipCode":' + JSON.stringify(v.zipCode) + ',"country":' + JSON.stringify(v.country) + "}";
  };
}, fn: void 0 }, "sj_P9r7Jh": { isNoop: false, typeName: "array", fnID: "sj", jitFnHash: "sj_P9r7Jh", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_G2AKWU = utl.getJIT("sj_G2AKWU"); return function sj_P9r7Jh(v){
 const ls0 = [];
 for (let i0 = 0; i0 < v.length; i0++) {
...
}, fn: void 0 }, "sj_AWciwE": { isNoop: false, typeName: "UserPreferences", fnID: "sj", jitFnHash: "sj_AWciwE", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const uErr0 = "Can not StringifyJson union: item does not belong to the union";
...
}, fn: void 0 }, "tBi_KgA2s8": { isNoop: false, typeName: "User", fnID: "tBi", jitFnHash: "tBi_KgA2s8", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_E2YuG4 = utl.getJIT("tBi_E2YuG4");
...
}, fn: void 0 }, "tBi_DD9DVL": { isNoop: false, typeName: "Address", fnID: "tBi", jitFnHash: "tBi_DD9DVL", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: "'use strict';  return function tBi_DD9DVL(v,Ser){Ser.serString(v.street);Ser.serString(v.city);Ser.serString(v.state);Ser.serString(v.zipCode);Ser.serString(v.country);\n; return Ser}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tBi_DD9DVL(utl) {
...
}, fn: void 0 }, "tBi_P9r7Jh": { isNoop: false, typeName: "array", fnID: "tBi", jitFnHash: "tBi_P9r7Jh", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_G2AKWU = utl.getJIT("tBi_G2AKWU"); return function tBi_P9r7Jh(v,Ser){
 Ser.view.setUint32(Ser.index, v.length, 1); Ser.index += 4;
...
}, fn: void 0 }, "tBi_AWciwE": { isNoop: false, typeName: "UserPreferences", fnID: "tBi", jitFnHash: "tBi_AWciwE", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not encode union to binary: item does not belong to the union";
...
}, fn: void 0 }, "fBi_KgA2s8": { isNoop: false, typeName: "User", fnID: "fBi", jitFnHash: "fBi_KgA2s8", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_E2YuG4 = utl.getJIT("fBi_E2YuG4");
...
}, fn: void 0 }, "fBi_E2YuG4": { isNoop: false, typeName: "UserRole", fnID: "fBi", jitFnHash: "fBi_E2YuG4", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index"; return function fBi_E2YuG4(ret,Des){
 const dec0 = Des.view.getUint8(Des.index++);
 if (dec0 === 0) {ret = "admin"}else if (dec0 === 1) {ret = "user"}else if (dec0 === 2) {ret = "guest"}else if (dec0 === 3) {ret = "moderator"}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fBi_vtjtZH": { isNoop: false, typeName: "AccountStatus", fnID: "fBi", jitFnHash: "fBi_vtjtZH", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index"; return function fBi_vtjtZH(ret,Des){
 const dec0 = Des.view.getUint8(Des.index++);
 if (dec0 === 0) {ret = "active"}else if (dec0 === 1) {ret = "suspended"}else if (dec0 === 2) {ret = "pending_verification"}else if (dec0 === 3) {ret = "deactivated"}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fBi_DD9DVL": { isNoop: false, typeName: "Address", fnID: "fBi", jitFnHash: "fBi_DD9DVL", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: "'use strict';  return function fBi_DD9DVL(ret,Des){return {street:Des.desString(),city:Des.desString(),state:Des.desString(),zipCode:Des.desString(),country:Des.desString()}}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fBi_DD9DVL(utl) {
  return function fBi_DD9DVL(ret, Des) {
    return { street: Des.desString(), city: Des.desString(), state: Des.desString(), zipCode: Des.desString(), country: Des.desString() };
  };
}, fn: void 0 }, "fBi_P9r7Jh": { isNoop: false, typeName: "array", fnID: "fBi", jitFnHash: "fBi_P9r7Jh", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_G2AKWU = utl.getJIT("fBi_G2AKWU"); return function fBi_P9r7Jh(ret,Des){
 const arrL0 = Des.view.getUint32(Des.index, 1); Des.index += 4; ret = new Array(arrL0);
...
}, fn: void 0 }, "fBi_G2AKWU": { isNoop: false, typeName: "PaymentMethod", fnID: "fBi", jitFnHash: "fBi_G2AKWU", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index"; return function fBi_G2AKWU(ret,Des){
 const dec0 = Des.view.getUint8(Des.index++);
 if (dec0 === 0) {ret = {type:"credit_card",lastFourDigits:Des.desString(),expiryMonth:Des.view.getFloat64(Des.index, 1, (Des.index += 8)),expiryYear:Des.view.getFloat64(Des.index, 1, (Des.index += 8)),brand:Des.desString()}}else if (dec0 === 1) {ret = {type:"bank_account",bankName:Des.desString(),accountLastFour:Des.desString(),routingNumber:Des.desString()}}else if (dec0 === 2) {ret = {type:"paypal",email:Des.desString()}}
 else {throw new Error(uErr0)}
...
}, fn: void 0 }, "fBi_AWciwE": { isNoop: false, typeName: "UserPreferences", fnID: "fBi", jitFnHash: "fBi_AWciwE", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const uErr0 = "Can not binary decode union: invalid union index";
...
}, fn: void 0 }, "te_bJLZ3X": { isNoop: false, typeName: "params", fnID: "te", jitFnHash: "te_bJLZ3X", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const te_H5fd3n = utl.getJIT("te_H5fd3n");
...
}, fn: void 0 }, "te_H5fd3n": { isNoop: false, typeName: "SimpleUser", fnID: "te", jitFnHash: "te_H5fd3n", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_H5fd3n(v,pth=[],er=[]){
 if (!(typeof v === 'object' && v !== null)) {
 Iqa2M8Ms(pth,er,"object");
 } else {
...
}, fn: void 0 }, "tj_bJLZ3X": { isNoop: true, typeName: "params", fnID: "tj", jitFnHash: "tj_bJLZ3X", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function tj_bJLZ3X(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tj_bJLZ3X(utl) {
  return function tj_bJLZ3X(v) {
    return v;
  };
}, fn: void 0 }, "tj_H5fd3n": { isNoop: true, typeName: "SimpleUser", fnID: "tj", jitFnHash: "tj_H5fd3n", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function tj_H5fd3n(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tj_H5fd3n(utl) {
  return function tj_H5fd3n(v) {
    return v;
  };
}, fn: void 0 }, "fj_bJLZ3X": { isNoop: false, typeName: "params", fnID: "fj", jitFnHash: "fj_bJLZ3X", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const fj_H5fd3n = utl.getJIT("fj_H5fd3n"); return function fj_bJLZ3X(v){v[0] = fj_H5fd3n.fn(v[0]); return v}`, jitDependencies: ["fj_H5fd3n"], pureFnDependencies: [], createJitFn: function get_fj_bJLZ3X(utl) {
  const fj_H5fd3n = utl.getJIT("fj_H5fd3n");
  return function fj_bJLZ3X(v) {
    v[0] = fj_H5fd3n.fn(v[0]);
    return v;
  };
}, fn: void 0 }, "fj_H5fd3n": { isNoop: false, typeName: "SimpleUser", fnID: "fj", jitFnHash: "fj_H5fd3n", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function fj_H5fd3n(v){v.lastUpdate = new Date(v.lastUpdate); return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fj_H5fd3n(utl) {
  return function fj_H5fd3n(v) {
    v.lastUpdate = new Date(v.lastUpdate);
    return v;
  };
}, fn: void 0 }, "sj_bJLZ3X": { isNoop: false, typeName: "params", fnID: "sj", jitFnHash: "sj_bJLZ3X", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict'; const sj_H5fd3n = utl.getJIT("sj_H5fd3n"); return function sj_bJLZ3X(v){return '['+sj_H5fd3n.fn(v[0])+']'}`, jitDependencies: ["sj_H5fd3n"], pureFnDependencies: [], createJitFn: function get_sj_bJLZ3X(utl) {
  const sj_H5fd3n = utl.getJIT("sj_H5fd3n");
  return function sj_bJLZ3X(v) {
    return "[" + sj_H5fd3n.fn(v[0]) + "]";
  };
}, fn: void 0 }, "sj_H5fd3n": { isNoop: false, typeName: "SimpleUser", fnID: "sj", jitFnHash: "sj_H5fd3n", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function sj_H5fd3n(v){return '{'+'"id":'+v.id+","+'"name":'+JSON.stringify(v.name)+","+'"surname":'+JSON.stringify(v.surname)+","+'"lastUpdate":'+'"'+v.lastUpdate.toJSON()+'"'+'}'}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_sj_H5fd3n(utl) {
...
}, fn: void 0 }, "tBi_bJLZ3X": { isNoop: false, typeName: "params", fnID: "tBi", jitFnHash: "tBi_bJLZ3X", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: `'use strict'; const tBi_H5fd3n = utl.getJIT("tBi_H5fd3n"); return function tBi_bJLZ3X(v,Ser){const tbmI0 = Ser.index; Ser.view.setUint8(Ser.index++, 0)
...
}, fn: void 0 }, "fBi_bJLZ3X": { isNoop: false, typeName: "params", fnID: "fBi", jitFnHash: "fBi_bJLZ3X", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: `'use strict'; const fBi_H5fd3n = utl.getJIT("fBi_H5fd3n"); return function fBi_bJLZ3X(ret,Des){ret = [];const tbimI0 = Des.index; Des.index += 1;
...
}, fn: void 0 }, "fBi_H5fd3n": { isNoop: false, typeName: "SimpleUser", fnID: "fBi", jitFnHash: "fBi_H5fd3n", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: "'use strict';  return function fBi_H5fd3n(ret,Des){return {id:Des.view.getFloat64(Des.index, 1, (Des.index += 8)),name:Des.desString(),surname:Des.desString(),lastUpdate:new Date(Des.view.getFloat64(Des.index, 1, (Des.index += 8)))}}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fBi_H5fd3n(utl) {
...
}, fn: void 0 }, "is_wKsME6": { isNoop: false, typeName: "SimpleUser", fnID: "is", jitFnHash: "is_wKsME6", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function is_wKsME6(v){return (typeof v === 'object' && v !== null && Number.isFinite(v.id) && typeof v.name === 'string' && typeof v.surname === 'string' && (v.lastUpdate instanceof Date && !isNaN(v.lastUpdate.getTime())))}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_is_wKsME6(utl) {
  return function is_wKsME6(v) {
    return typeof v === "object" && v !== null && Number.isFinite(v.id) && typeof v.name === "string" && typeof v.surname === "string" && (v.lastUpdate instanceof Date && !isNaN(v.lastUpdate.getTime()));
  };
}, fn: void 0 }, "te_wKsME6": { isNoop: false, typeName: "SimpleUser", fnID: "te", jitFnHash: "te_wKsME6", args: { "pλth": "pth", "εrr": "er", "vλl": "v" }, defaultParamValues: { "pλth": "[]", "εrr": "[]", "vλl": "" }, code: `'use strict'; const Iqa2M8Ms = utl.getPureFn("mion", "newRunTypeErr"); return function te_wKsME6(v,pth=[],er=[]){
 if (!(typeof v === 'object' && v !== null)) {
 Iqa2M8Ms(pth,er,"object");
 } else {
 if(!(Number.isFinite(v.id))) Iqa2M8Ms(pth,er,"number",["id"]);if (typeof v.name !== 'string') Iqa2M8Ms(pth,er,"string",["name"]);if (typeof v.surname !== 'string') Iqa2M8Ms(pth,er,"string",["surname"]);if (!(v.lastUpdate instanceof Date && !isNaN(v.lastUpdate.getTime()))) Iqa2M8Ms(pth,er,"date",["lastUpdate"]);
...
}, fn: void 0 }, "tj_wKsME6": { isNoop: true, typeName: "SimpleUser", fnID: "tj", jitFnHash: "tj_wKsME6", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function tj_wKsME6(v){return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tj_wKsME6(utl) {
  return function tj_wKsME6(v) {
    return v;
  };
}, fn: void 0 }, "fj_wKsME6": { isNoop: false, typeName: "SimpleUser", fnID: "fj", jitFnHash: "fj_wKsME6", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: "'use strict';  return function fj_wKsME6(v){v.lastUpdate = new Date(v.lastUpdate); return v}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fj_wKsME6(utl) {
  return function fj_wKsME6(v) {
    v.lastUpdate = new Date(v.lastUpdate);
    return v;
  };
}, fn: void 0 }, "sj_wKsME6": { isNoop: false, typeName: "SimpleUser", fnID: "sj", jitFnHash: "sj_wKsME6", args: { "vλl": "v" }, defaultParamValues: { "vλl": "" }, code: `'use strict';  return function sj_wKsME6(v){return '{'+'"id":'+v.id+","+'"name":'+JSON.stringify(v.name)+","+'"surname":'+JSON.stringify(v.surname)+","+'"lastUpdate":'+'"'+v.lastUpdate.toJSON()+'"'+'}'}`, jitDependencies: [], pureFnDependencies: [], createJitFn: function get_sj_wKsME6(utl) {
  return function sj_wKsME6(v) {
    return '{"id":' + v.id + ',"name":' + JSON.stringify(v.name) + ',"surname":' + JSON.stringify(v.surname) + ',"lastUpdate":"' + v.lastUpdate.toJSON() + '"}';
  };
}, fn: void 0 }, "tBi_wKsME6": { isNoop: false, typeName: "SimpleUser", fnID: "tBi", jitFnHash: "tBi_wKsME6", args: { "sεr": "Ser", "vλl": "v" }, defaultParamValues: { "sεr": "", "vλl": "" }, code: "'use strict';  return function tBi_wKsME6(v,Ser){Ser.view.setFloat64(Ser.index,v.id, 1, (Ser.index += 8));Ser.serString(v.name);Ser.serString(v.surname);Ser.view.setFloat64(Ser.index, v.lastUpdate.getTime(), 1, (Ser.index += 8));\n; return Ser}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_tBi_wKsME6(utl) {
...
}, fn: void 0 }, "fBi_wKsME6": { isNoop: false, typeName: "SimpleUser", fnID: "fBi", jitFnHash: "fBi_wKsME6", args: { "dεs": "Des", "vλl": "ret" }, defaultParamValues: { "dεs": "", "vλl": "" }, code: "'use strict';  return function fBi_wKsME6(ret,Des){return {id:Des.view.getFloat64(Des.index, 1, (Des.index += 8)),name:Des.desString(),surname:Des.desString(),lastUpdate:new Date(Des.view.getFloat64(Des.index, 1, (Des.index += 8)))}}", jitDependencies: [], pureFnDependencies: [], createJitFn: function get_fBi_wKsME6(utl) {
